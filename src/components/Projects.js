...
export default function Projects() {
  return (
    ...
    <div id='projects' className="bg-black">
        <div>
            <h1 className='text-center text-5xl mb-14'> <a href="#home">Projects</a></h1>
        </div>
        <div className=' flex md:flex-row flex-col align-middle w-full justify-center md:justify-evenly md:align-items text-white '>
            <div className="project1 flex flex-col items-center transform hover:scale-90 hover:bg-sky-400 transition duration-400 ease-in-out h-auto my-6 w-80 m-auto border-2 rounded-2xl mb-20">
            ...
            <div className="project2 flex flex-col items-center transform hover:scale-90 hover:bg-sky-400 transition duration-400 ease-in-out h-auto my-6 w-80 m-auto border-2 rounded-2xl mb-20">
            ...
            <div className="project3 flex flex-col items-center transform hover:scale-90 hover:bg-sky-400 animate-zoom-in transition duration-400 ease-in-out h-auto my-6 w-80 m-auto border-2 rounded-2xl mb-20">
